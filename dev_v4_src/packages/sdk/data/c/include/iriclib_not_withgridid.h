...
int IRICLIBDLL cg_iRIC_Read_Grid_Complex_IFace(int fid, const char* groupname, int* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Complex_JFace(int fid, const char* groupname, int* v_arr);
...
int IRICLIBDLL cg_iRIC_Write_Grid_Complex_IFace(int fid, const char* groupname, int* v_arr);
int IRICLIBDLL cg_iRIC_Write_Grid_Complex_JFace(int fid, const char* groupname, int* v_arr);
...
int IRICLIBDLL cg_iRIC_Read_Grid_CellType(int fid, int* type);
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElementsSize(int fid, int* tsize);
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElementsSize2(int fid, int* tsize);
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElements(int fid, int* id_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_LineElementsSize(int fid, int* tsize);
int IRICLIBDLL cg_iRIC_Read_Grid_LineElementsSize2(int fid, int* tsize);
int IRICLIBDLL cg_iRIC_Read_Grid_LineElements(int fid, int* id_arr);
...
int IRICLIBDLL cg_iRIC_Read_Grid_StringMaxLen_Node(int fid, const char* name, int* smsize);
int IRICLIBDLL cg_iRIC_Read_Grid_String_Node(int fid, const char* name, char* v_arr);
...
int IRICLIBDLL cg_iRIC_Read_Grid_StringMaxLen_Cell(int fid, const char* name, int* smsize);
int IRICLIBDLL cg_iRIC_Read_Grid_String_Cell(int fid, const char* name, char* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Real_IFace(int fid, const char* name, double* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Integer_IFace(int fid, const char* name, int* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_StringMaxLen_IFace(int fid, const char* name, int* smsize);
int IRICLIBDLL cg_iRIC_Read_Grid_String_IFace(int fid, const char* name, char* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Real_JFace(int fid, const char* name, double* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Integer_JFace(int fid, const char* name, int* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_StringMaxLen_JFace(int fid, const char* name, int* smsize);
int IRICLIBDLL cg_iRIC_Read_Grid_String_JFace(int fid, const char* name, char* v_arr);
...
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_StringMaxLen_Node(int fid, const char* name, int dimid, int* smsize);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_String_Node(int fid, const char* name, int dimid, char* v_arr);
...
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_StringMaxLen_Cell(int fid, const char* name, int dimid, int* smsize);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_String_Cell(int fid, const char* name, int dimid, char* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_Integer_IFace(int fid, const char* name, int dimid, int* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_Real_IFace(int fid, const char* name, int dimid, double* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_StringMaxLen_IFace(int fid, const char* name, int dimid, int* smsize);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_String_IFace(int fid, const char* name, int dimid, char* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_Integer_JFace(int fid, const char* name, int dimid, int* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_Real_JFace(int fid, const char* name, int dimid, double* v_arr);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_StringMaxLen_JFace(int fid, const char* name, int dimid, int* smsize);
int IRICLIBDLL cg_iRIC_Read_Grid_Functional_String_JFace(int fid, const char* name, int dimid, char* v_arr);
...
int IRICLIBDLL cg_iRIC_Write_Grid2d_Unst_Triangles(int fid, int psize, double* x_arr, double* y_arr, int csize, int* idx_arr);
int IRICLIBDLL cg_iRIC_Write_Grid2d_Unst_Lines(int fid, int psize, double* x_arr, double* y_arr, int csize, int* idx_arr);
int IRICLIBDLL cg_iRIC_Write_Grid3d_Unst_Lines(int fid, int psize, double* x_arr, double* y_arr, double* z_arr, int csize, int* idx_arr);
int IRICLIBDLL cg_iRIC_Write_NamedGrid2d_Unst_Triangles(int fid, const char* name, int psize, double* x_arr, double* y_arr, int csize, int* idx_arr);
int IRICLIBDLL cg_iRIC_Write_NamedGrid2d_Unst_Lines(int fid, const char* name, int psize, double* x_arr, double* y_arr, int csize, int* idx_arr);
int IRICLIBDLL cg_iRIC_Write_NamedGrid3d_Unst_Lines(int fid, const char* name, int psize, double* x_arr, double* y_arr, double* z_arr, int csize, int* idx_arr);
...
int IRICLIBDLL cg_iRIC_Write_Grid_String_Node(int fid, const char* name, int maxlen, char* v_arr);
...
int IRICLIBDLL cg_iRIC_Write_Grid_String_Cell(int fid, const char* name, int maxlen, char* v_arr);
int IRICLIBDLL cg_iRIC_Write_Grid_Real_IFace(int fid, const char* name, double* v_arr);
int IRICLIBDLL cg_iRIC_Write_Grid_Integer_IFace(int fid, const char* name, int* v_arr);
int IRICLIBDLL cg_iRIC_Write_Grid_String_IFace(int fid, const char* name, int maxlen, char* v_arr);
int IRICLIBDLL cg_iRIC_Write_Grid_Real_JFace(int fid, const char* name, double* v_arr);
int IRICLIBDLL cg_iRIC_Write_Grid_Integer_JFace(int fid, const char* name, int* v_arr);
int IRICLIBDLL cg_iRIC_Write_Grid_String_JFace(int fid, const char* name, int maxlen, char* v_arr);
...
int IRICLIBDLL cg_iRIC_Read_Sol_Grid2d_Open(int fid, int step, int* grid_handle);
...
int IRICLIBDLL cg_iRIC_Write_Sol_ParticleGroup_GroupBegin(int fid, const char* groupname);
...
int IRICLIBDLL cg_iRIC_Write_Sol_ParticleGroupImage_GroupBegin(int fid, const char* groupname);
...
int IRICLIBDLL cg_iRIC_Write_Sol_PolyData_GroupBegin(int fid, const char* groupname);
